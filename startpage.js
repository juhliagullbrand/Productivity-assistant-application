...
if (currentUser) {
    var todos = JSON.parse(localStorage.getItem(`todos_${currentUser}`)) || [];
    var habits = JSON.parse(localStorage.getItem(`routines_${currentUser}`)) || [];
    var events = JSON.parse(localStorage.getItem(`events_${currentUser}`)) || [];
} else {
    var todos = [];
    var habits = [];
    var events = [];
